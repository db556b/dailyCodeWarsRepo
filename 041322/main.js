...
function goodVsEvil(good, evil){
    ...
    const goodTot = +good[0] + +good[1] * 2 + +good[2] * 3 + +good[3] * 3 + +good[4] * 4 + +good[5] * 10
    const evilTot = +evil[0] + +evil[1] * 2 + +evil[2] * 2 + +evil[3] * 2 + +evil[4] * 3 + +evil[5] * 5 + +evil[6] * 10
    console.log(goodTot, evilTot)
    return goodTot === evilTot ? 'Battle Result: No victor on this battle field' : 
           goodTot < evilTot ? 'Battle Result: Evil eradicates all trace of Good' : 
